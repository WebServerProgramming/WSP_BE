...
public class CalendarController {
    ...
    @GetMapping("/all")
    public ApplicationResponse<List<String>> getAllCalendar(
            @UserResolver User user
    ) {
        List<String> calendarDates = voteService.getAllCalendar(user);
    ...
    public ApplicationResponse<List<String>> getSingleCalendar(
            @UserResolver User user,
            @PathVariable Long clubId
    ) {
        List<String> calendarDates = voteService.getSingleCalendar(user, clubId);
        return ApplicationResponse.ok(calendarDates);
    }
}
